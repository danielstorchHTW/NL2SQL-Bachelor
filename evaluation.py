    ...
    for i, (p, g) in enumerate(zip(plist, glist)):
        ...
        for idx, pg in enumerate(zip(p, g)):
            ...
            if not os.path.exists(db):
                print(f"Skipping: Database file {db} does not exist.")
                continue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gold', dest='gold', type=str, default='spider/dev_gold.sql')
    parser.add_argument('--pred', dest='pred', type=str, default='prediction.txt')
    parser.add_argument('--db', dest='db', type=str, default='spider/database')
    parser.add_argument('--table', dest='table', type=str, default='spider/tables.json')
    ...
    parser.add_argument('--progress_bar_for_each_datapoint', default=True, action='store_true')
